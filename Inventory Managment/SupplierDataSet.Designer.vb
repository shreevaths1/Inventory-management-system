...
Partial Public Class SupplierDataSet
    ...
    Partial Public Class SUPPLIERDataTable
        ...
        Private columnSUPPLER_CONTACT As Global.System.Data.DataColumn
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public ReadOnly Property SUPPLER_CONTACTColumn() As Global.System.Data.DataColumn
            Get
                Return Me.columnSUPPLER_CONTACT
            End Get
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddSUPPLIERRow(ByVal SUPPLIER_ID As Decimal, ByVal SUPPLIER_NAME As String, ByVal SUPPLER_CONTACT As Decimal, ByVal SUPPLIER_ADDRESS As String, ByVal SUPPLIER_EMAIL As String) As SUPPLIERRow
            Dim rowSUPPLIERRow As SUPPLIERRow = CType(Me.NewRow,SUPPLIERRow)
            Dim columnValuesArray() As Object = New Object() {SUPPLIER_ID, SUPPLIER_NAME, SUPPLER_CONTACT, SUPPLIER_ADDRESS, SUPPLIER_EMAIL}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function FindBySUPPLIER_ID(ByVal SUPPLIER_ID As Decimal) As SUPPLIERRow
        ...
        Friend Sub InitVars()
            ...
            Me.columnSUPPLER_CONTACT = MyBase.Columns("SUPPLER_CONTACT")
        ...
        Private Sub InitClass()
            ...
            Me.columnSUPPLER_CONTACT = New Global.System.Data.DataColumn("SUPPLER_CONTACT", GetType(Decimal), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnSUPPLER_CONTACT)
            ...
            Me.columnSUPPLER_CONTACT.AllowDBNull = false
    ...
    Partial Public Class SUPPLIERRow
        ...
        Public Property SUPPLIER_ID() As Decimal
            Get
                Return CType(Me(Me.tableSUPPLIER.SUPPLIER_IDColumn),Decimal)
            End Get
            Set
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Property SUPPLER_CONTACT() As Decimal
            Get
                Return CType(Me(Me.tableSUPPLIER.SUPPLER_CONTACTColumn),Decimal)
            End Get
            Set
                Me(Me.tableSUPPLIER.SUPPLER_CONTACTColumn) = value
            End Set
        End Property
...
Namespace SupplierDataSetTableAdapters
    ...
    Partial Public Class SUPPLIERTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            tableMapping.ColumnMappings.Add("SUPPLER_CONTACT", "SUPPLER_CONTACT")
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM ""INVUSER"".""SUPPLIER"" WHERE ((""SUPPLIER_ID"" = :Original_SUPPLIER_ID) A"& _ 
                "ND (""SUPPLIER_NAME"" = :Original_SUPPLIER_NAME) AND (""SUPPLER_CONTACT"" = :Origina"& _ 
                "l_SUPPLER_CONTACT) AND (""SUPPLIER_ADDRESS"" = :Original_SUPPLIER_ADDRESS) AND (""S"& _ 
                "UPPLIER_EMAIL"" = :Original_SUPPLIER_EMAIL))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(param)
            param = New Global.Oracle.ManagedDataAccess.Client.OracleParameter()
            param.ParameterName = "Original_SUPPLER_CONTACT"
            param.DbType = Global.System.Data.DbType.[Decimal]
            param.OracleDbTypeEx = Global.Oracle.ManagedDataAccess.Client.OracleDbType.[Decimal]
            param.Size = 22
            param.IsNullable = true
            param.SourceColumn = "SUPPLER_CONTACT"
            param.SourceVersion = Global.System.Data.DataRowVersion.Original
            Me._adapter.DeleteCommand.Parameters.Add(param)
            param = New Global.Oracle.ManagedDataAccess.Client.OracleParameter()
            param.ParameterName = "Original_SUPPLIER_ADDRESS"
            param.OracleDbTypeEx = Global.Oracle.ManagedDataAccess.Client.OracleDbType.Varchar2
            param.Size = 100
            param.IsNullable = true
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO ""INVUSER"".""SUPPLIER"" (""SUPPLIER_ID"", ""SUPPLIER_NAME"", ""SUPPLER_CONTAC"& _ 
                "T"", ""SUPPLIER_ADDRESS"", ""SUPPLIER_EMAIL"") VALUES (:SUPPLIER_ID, :SUPPLIER_NAME, "& _ 
                ":SUPPLER_CONTACT, :SUPPLIER_ADDRESS, :SUPPLIER_EMAIL)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(param)
            param = New Global.Oracle.ManagedDataAccess.Client.OracleParameter()
            param.ParameterName = "SUPPLER_CONTACT"
            param.DbType = Global.System.Data.DbType.[Decimal]
            param.OracleDbTypeEx = Global.Oracle.ManagedDataAccess.Client.OracleDbType.[Decimal]
            param.Size = 22
            param.IsNullable = true
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE ""INVUSER"".""SUPPLIER"" SET ""SUPPLIER_ID"" = :SUPPLIER_ID, ""SUPPLIER_NAME"" = :"& _ 
                "SUPPLIER_NAME, ""SUPPLER_CONTACT"" = :SUPPLER_CONTACT, ""SUPPLIER_ADDRESS"" = :SUPPL"& _ 
                "IER_ADDRESS, ""SUPPLIER_EMAIL"" = :SUPPLIER_EMAIL WHERE ((""SUPPLIER_ID"" = :Origina"& _ 
                "l_SUPPLIER_ID) AND (""SUPPLIER_NAME"" = :Original_SUPPLIER_NAME) AND (""SUPPLER_CON"& _ 
                "TACT"" = :Original_SUPPLER_CONTACT) AND (""SUPPLIER_ADDRESS"" = :Original_SUPPLIER_"& _ 
                "ADDRESS) AND (""SUPPLIER_EMAIL"" = :Original_SUPPLIER_EMAIL))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT SUPPLIER_ID, SUPPLIER_NAME, SUPPLER_CONTACT, SUPPLIER_ADDRESS, SUPPLIER_EM"& _ 
                "AIL FROM INVUSER.SUPPLIER"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_SUPPLIER_ID As Decimal, ByVal Original_SUPPLIER_NAME As String, ByVal Original_SUPPLER_CONTACT As Decimal, ByVal Original_SUPPLIER_ADDRESS As String, ByVal Original_SUPPLIER_EMAIL As String) As Integer
            Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_SUPPLIER_ID,Decimal)
            ...
            End If
            Me.Adapter.DeleteCommand.Parameters(2).Value = CType(Original_SUPPLER_CONTACT,Decimal)
            If (Original_SUPPLIER_ADDRESS Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_SUPPLIER_ADDRESS")
            Else
                Me.Adapter.DeleteCommand.Parameters(3).Value = CType(Original_SUPPLIER_ADDRESS,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal SUPPLIER_ID As Decimal, ByVal SUPPLIER_NAME As String, ByVal SUPPLER_CONTACT As Decimal, ByVal SUPPLIER_ADDRESS As String, ByVal SUPPLIER_EMAIL As String) As Integer
            Me.Adapter.InsertCommand.Parameters(0).Value = CType(SUPPLIER_ID,Decimal)
            ...
            End If
            Me.Adapter.InsertCommand.Parameters(2).Value = CType(SUPPLER_CONTACT,Decimal)
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(4).Value = CType(SUPPLIER_EMAIL,String)
            End If
        ...
        Public Overloads Overridable Function Update(ByVal SUPPLIER_ID As Decimal, ByVal SUPPLIER_NAME As String, ByVal SUPPLER_CONTACT As Decimal, ByVal SUPPLIER_ADDRESS As String, ByVal SUPPLIER_EMAIL As String, ByVal Original_SUPPLIER_ID As Decimal, ByVal Original_SUPPLIER_NAME As String, ByVal Original_SUPPLER_CONTACT As Decimal, ByVal Original_SUPPLIER_ADDRESS As String, ByVal Original_SUPPLIER_EMAIL As String) As Integer
            Me.Adapter.UpdateCommand.Parameters(0).Value = CType(SUPPLIER_ID,Decimal)
            If (SUPPLIER_NAME Is Nothing) Then
                Throw New Global.System.ArgumentNullException("SUPPLIER_NAME")
            Else
                Me.Adapter.UpdateCommand.Parameters(1).Value = CType(SUPPLIER_NAME,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(2).Value = CType(SUPPLER_CONTACT,Decimal)
            If (SUPPLIER_ADDRESS Is Nothing) Then
                Throw New Global.System.ArgumentNullException("SUPPLIER_ADDRESS")
            Else
            ...
            If (SUPPLIER_EMAIL Is Nothing) Then
                Throw New Global.System.ArgumentNullException("SUPPLIER_EMAIL")
            Else
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(SUPPLIER_EMAIL,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Original_SUPPLIER_ID,Decimal)
            If (Original_SUPPLIER_NAME Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_SUPPLIER_NAME")
            Else
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_SUPPLIER_NAME,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_SUPPLER_CONTACT,Decimal)
            If (Original_SUPPLIER_ADDRESS Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_SUPPLIER_ADDRESS")
            Else
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_SUPPLIER_ADDRESS,String)
            End If
            If (Original_SUPPLIER_EMAIL Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_SUPPLIER_EMAIL")
            Else
                Me.Adapter.UpdateCommand.Parameters(9).Value = CType(Original_SUPPLIER_EMAIL,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal SUPPLIER_NAME As String, ByVal SUPPLER_CONTACT As Decimal, ByVal SUPPLIER_ADDRESS As String, ByVal SUPPLIER_EMAIL As String, ByVal Original_SUPPLIER_ID As Decimal, ByVal Original_SUPPLIER_NAME As String, ByVal Original_SUPPLER_CONTACT As Decimal, ByVal Original_SUPPLIER_ADDRESS As String, ByVal Original_SUPPLIER_EMAIL As String) As Integer
            Return Me.Update(Original_SUPPLIER_ID, SUPPLIER_NAME, SUPPLER_CONTACT, SUPPLIER_ADDRESS, SUPPLIER_EMAIL, Original_SUPPLIER_ID, Original_SUPPLIER_NAME, Original_SUPPLER_CONTACT, Original_SUPPLIER_ADDRESS, Original_SUPPLIER_EMAIL)
        End Function
    End Class
