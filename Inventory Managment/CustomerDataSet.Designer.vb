...
Partial Public Class CustomerDataSet
    ...
    Partial Public Class CUSTOMERDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddCUSTOMERRow(ByVal CUST_ID As Decimal, ByVal CUST_NAME As String, ByVal CONTACT As Decimal, ByVal ADDRESS As String, ByVal EMAIL As String) As CUSTOMERRow
            Dim rowCUSTOMERRow As CUSTOMERRow = CType(Me.NewRow,CUSTOMERRow)
            Dim columnValuesArray() As Object = New Object() {CUST_ID, CUST_NAME, CONTACT, ADDRESS, EMAIL}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function FindByCUST_ID(ByVal CUST_ID As Decimal) As CUSTOMERRow
    ...
    Partial Public Class CUSTOMERRow
        ...
        Public Property CUST_ID() As Decimal
            Get
                Return CType(Me(Me.tableCUSTOMER.CUST_IDColumn),Decimal)
            End Get
            Set
        ...
        Public Property CONTACT() As Decimal
            Get
                Return CType(Me(Me.tableCUSTOMER.CONTACTColumn),Decimal)
            End Get
            Set
...
Namespace CustomerDataSetTableAdapters
    ...
    Partial Public Class CUSTOMERTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM ""INVUSER"".""CUSTOMER"" WHERE ((""CUST_ID"" = :Original_CUST_ID) AND (""CUS"& _ 
                "T_NAME"" = :Original_CUST_NAME) AND (""CONTACT"" = :Original_CONTACT) AND (""ADDRESS"& _ 
                """ = :Original_ADDRESS) AND (""EMAIL"" = :Original_EMAIL))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO ""INVUSER"".""CUSTOMER"" (""CUST_ID"", ""CUST_NAME"", ""CONTACT"", ""ADDRESS"", """& _ 
                "EMAIL"") VALUES (:CUST_ID, :CUST_NAME, :CONTACT, :ADDRESS, :EMAIL)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE ""INVUSER"".""CUSTOMER"" SET ""CUST_ID"" = :CUST_ID, ""CUST_NAME"" = :CUST_NAME, """& _ 
                "CONTACT"" = :CONTACT, ""ADDRESS"" = :ADDRESS, ""EMAIL"" = :EMAIL WHERE ((""CUST_ID"" = "& _ 
                ":Original_CUST_ID) AND (""CUST_NAME"" = :Original_CUST_NAME) AND (""CONTACT"" = :Ori"& _ 
                "ginal_CONTACT) AND (""ADDRESS"" = :Original_ADDRESS) AND (""EMAIL"" = :Original_EMAI"& _ 
                "L))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT CUST_ID, CUST_NAME, CONTACT, ADDRESS, EMAIL FROM INVUSER.CUSTOMER"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_CUST_ID As Decimal, ByVal Original_CUST_NAME As String, ByVal Original_CONTACT As Decimal, ByVal Original_ADDRESS As String, ByVal Original_EMAIL As String) As Integer
            Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_CUST_ID,Decimal)
            ...
            End If
            Me.Adapter.DeleteCommand.Parameters(2).Value = CType(Original_CONTACT,Decimal)
        ...
        Public Overloads Overridable Function Insert(ByVal CUST_ID As Decimal, ByVal CUST_NAME As String, ByVal CONTACT As Decimal, ByVal ADDRESS As String, ByVal EMAIL As String) As Integer
            Me.Adapter.InsertCommand.Parameters(0).Value = CType(CUST_ID,Decimal)
            ...
            End If
            Me.Adapter.InsertCommand.Parameters(2).Value = CType(CONTACT,Decimal)
        ...
        Public Overloads Overridable Function Update(ByVal CUST_ID As Decimal, ByVal CUST_NAME As String, ByVal CONTACT As Decimal, ByVal ADDRESS As String, ByVal EMAIL As String, ByVal Original_CUST_ID As Decimal, ByVal Original_CUST_NAME As String, ByVal Original_CONTACT As Decimal, ByVal Original_ADDRESS As String, ByVal Original_EMAIL As String) As Integer
            Me.Adapter.UpdateCommand.Parameters(0).Value = CType(CUST_ID,Decimal)
            If (CUST_NAME Is Nothing) Then
                Throw New Global.System.ArgumentNullException("CUST_NAME")
            Else
                Me.Adapter.UpdateCommand.Parameters(1).Value = CType(CUST_NAME,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(2).Value = CType(CONTACT,Decimal)
            If (ADDRESS Is Nothing) Then
                Throw New Global.System.ArgumentNullException("ADDRESS")
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Original_CUST_ID,Decimal)
            If (Original_CUST_NAME Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_CUST_NAME")
            Else
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_CUST_NAME,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_CONTACT,Decimal)
            If (Original_ADDRESS Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_ADDRESS")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal CUST_NAME As String, ByVal CONTACT As Decimal, ByVal ADDRESS As String, ByVal EMAIL As String, ByVal Original_CUST_ID As Decimal, ByVal Original_CUST_NAME As String, ByVal Original_CONTACT As Decimal, ByVal Original_ADDRESS As String, ByVal Original_EMAIL As String) As Integer
            Return Me.Update(Original_CUST_ID, CUST_NAME, CONTACT, ADDRESS, EMAIL, Original_CUST_ID, Original_CUST_NAME, Original_CONTACT, Original_ADDRESS, Original_EMAIL)
        End Function
    End Class
        ...
        Public Overridable Function UpdateAll(ByVal dataSet As CustomerDataSet) As Integer
            ...
            Try 
                ...
                If (Not (Me._cUSTOMERTableAdapter) Is Nothing) Then
                    ...
                    Me._cUSTOMERTableAdapter.Connection = CType(workConnection,Global.Oracle.ManagedDataAccess.Client.OracleConnection)
                    Me._cUSTOMERTableAdapter.Transaction = CType(workTransaction,Global.Oracle.ManagedDataAccess.Client.OracleTransaction)
            ...
            Finally
                ...
                End If
                If (Not (Me._cUSTOMERTableAdapter) Is Nothing) Then
                    Me._cUSTOMERTableAdapter.Connection = CType(revertConnections(Me._cUSTOMERTableAdapter),Global.Oracle.ManagedDataAccess.Client.OracleConnection)
